...
namespace Data.AW2019
{
    public partial class aw2019Context : DbContext
    {
        private static aw2019Context _instance;
        public static aw2019Context GetInstance()
        {
            _instance = _instance ?? (_instance = new aw2019Context());
            return _instance;
        }

        private aw2019Context() : base("name=aw2019Context")
        {
        }
